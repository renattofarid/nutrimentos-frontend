...
const colorClasses = {
  ...
  primary: {
    ...
    svgText: "[&_svg]:text-primary dark:[&_svg]:text-blue-400",
    border: "border-primary dark:border-blue-500",
    bg: "bg-primary text-primary-foreground dark:bg-blue-600",
    bgSolid: "bg-primary text-primary-foreground dark:bg-blue-600",
    hoverSolid: "hover:bg-primary/90 dark:hover:bg-blue-600",
    hoverOutline:
      "hover:bg-primary/5 dark:hover:bg-blue-950 hover:text-primary dark:hover:text-blue-400",
  },

  muted: {
    text: "text-muted-foreground",
    svgText: "[&_svg]:text-muted-foreground",
  ...
  slate: {
    ...
    svgText: "[&_svg]:text-slate-500 dark:[&_svg]:text-slate-400",
  ...
  gray: {
    ...
    svgText: "[&_svg]:text-gray-500 dark:[&_svg]:text-gray-400",
  ...
  zinc: {
    ...
    svgText: "[&_svg]:text-zinc-500 dark:[&_svg]:text-zinc-400",
  ...
  neutral: {
    ...
    svgText: "[&_svg]:text-neutral-500 dark:[&_svg]:text-neutral-400",
  ...
  stone: {
    ...
    svgText: "[&_svg]:text-stone-500 dark:[&_svg]:text-stone-400",
  ...
  red: {
    ...
    svgText: "[&_svg]:text-red-500 dark:[&_svg]:text-red-400",
  ...
  rose: {
    ...
    svgText: "[&_svg]:text-rose-500 dark:[&_svg]:text-rose-400",
  ...
  orange: {
    ...
    svgText: "[&_svg]:text-orange-500 dark:[&_svg]:text-orange-400",
  ...
  amber: {
    ...
    svgText: "[&_svg]:text-amber-500 dark:[&_svg]:text-amber-400",
  ...
  yellow: {
    ...
    svgText: "[&_svg]:text-yellow-500 dark:[&_svg]:text-yellow-400",
  ...
  lime: {
    ...
    svgText: "[&_svg]:text-lime-500 dark:[&_svg]:text-lime-400",
  ...
  green: {
    ...
    svgText: "[&_svg]:text-green-500 dark:[&_svg]:text-green-400",
  ...
  emerald: {
    ...
    svgText: "[&_svg]:text-emerald-500 dark:[&_svg]:text-emerald-400",
  ...
  teal: {
    ...
    svgText: "[&_svg]:text-teal-500 dark:[&_svg]:text-teal-400",
  ...
  cyan: {
    ...
    svgText: "[&_svg]:text-cyan-500 dark:[&_svg]:text-cyan-400",
  ...
  sky: {
    ...
    svgText: "[&_svg]:text-sky-500 dark:[&_svg]:text-sky-400",
  ...
  blue: {
    ...
    svgText: "[&_svg]:text-blue-500 dark:[&_svg]:text-blue-400",
  ...
  indigo: {
    ...
    svgText: "[&_svg]:text-indigo-500 dark:[&_svg]:text-indigo-400",
  ...
  violet: {
    ...
    svgText: "[&_svg]:text-violet-500 dark:[&_svg]:text-violet-400",
  ...
  purple: {
    ...
    svgText: "[&_svg]:text-purple-500 dark:[&_svg]:text-purple-400",
  ...
  fuchsia: {
    ...
    svgText: "[&_svg]:text-fuchsia-500 dark:[&_svg]:text-fuchsia-400",
  ...
  pink: {
    ...
    svgText: "[&_svg]:text-pink-500 dark:[&_svg]:text-pink-400",
  ...
  "cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      ...
      color: Object.fromEntries(colorKeys.map((key) => [key, ""])) as Record<
        ...
        string
      >,
      colorIcon: Object.fromEntries(
        colorKeys.map((key) => [key, ""]),
      ) as Record<keyof typeof colorClasses, string>,
      size: {
        default:
    ...
    compoundVariants: [
      ...
      // colorIcon: aplica color solo al SVG hijo
      ...colorKeys.map((color) => ({
        colorIcon: color,
        class: colorClasses[color].svgText,
      })),
    ],
    defaultVariants: {
      variant: "default",
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const button = (
      <Comp
        className={cn(
          buttonVariants({ variant, size, color, colorIcon, className }),
        )}
        ref={ref}
        {...props}
      />
