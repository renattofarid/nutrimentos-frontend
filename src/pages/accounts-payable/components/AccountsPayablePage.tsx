...
export default function AccountsPayablePage() {
  ...
  const fetchInstallments = async () => {
    setIsLoading(true);
    try {
      const data = await getAllPurchaseInstallments();
  ...
  const handleOpenPayment = (installment: PurchaseInstallmentResource) => {
    // TODO: Implementar modal de gestión de pagos
    console.log("Abrir gestión de pagos para:", installment);
  };

  const handleOpenQuickView = (installment: PurchaseInstallmentResource) => {
    // TODO: Implementar vista rápida de pagos
    console.log("Abrir vista rápida para:", installment);
  };
